...
inline bool CarControlSP::Reader::getLeadVisible() const {
  return _reader.getDataField<bool>(
      ::capnp::bounded<64>() * ::capnp::ELEMENTS);
}

inline bool CarControlSP::Builder::getLeadVisible() {
  return _builder.getDataField<bool>(
      ::capnp::bounded<64>() * ::capnp::ELEMENTS);
}
inline void CarControlSP::Builder::setLeadVisible(bool value) {
  _builder.setDataField<bool>(
